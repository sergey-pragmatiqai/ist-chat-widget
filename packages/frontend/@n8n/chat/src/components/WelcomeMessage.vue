...
<template>
  <Transition name="welcome-message-transition" @before-leave="onBeforeLeave">
    <div v-if="show && welcomeText" class="welcome-message">
      ...
      <div class="welcome-message-content" @click="handleClick">
        <div v-if="welcomeIcon" class="welcome-message-icon">
          ...
          />
          <span v-else class="welcome-message-icon-emoji">{{
            welcomeIcon
          }}</span>
        </div>
        <div v-if="welcomeText" class="welcome-message-text">
          {{ welcomeText }}
        </div>
      </div>
